...
#Mimic internal package environment
iTrack <- BarSeqTools:::iTrack
...
upTagsAutoSafe <- "upTagsAutoSafe.csv"
dnTagsAutoSafe <- "dnTagsAutoSafe.csv"
...
###Set up before reactive environment
...
###Run within reactive environment
...
dnTagsCol <- totalTagsTableOutput[[1]]
upTagsCol <- totalTagsTableOutput[[2]]
totalTagsTable <- totalTagsTableOutput[[3]]

upTagTracks <- constructAlignedReadTrack(upTagsCol, "upTags")
dnTagTracks <- constructAlignedReadTrack(dnTagsCol, "dnTags")

allFeatures <- createAllFeatures(upTagsCol, dnTagsCol, myTxDb, gene, totalTagsTable, minDist)

i <- 1
plotAllTracks(i, allFeatures, gene, totalTagsTable, minDist, ax, gr, upTagTracks, dnTagTracks, iTrack)

plotBarcodeGeneNetwork(gene, "upTags", upTags, upTagsAgg, totalTagsTable, minTagGeneFreq, 0.01)
plotBarcodeGeneNetwork(gene, "dnTags", dnTags, dnTagsAgg, totalTagsTable, minTagGeneFreq, 0.01)
